    ...
    if usr_cmdall1.startswith("/start subinps"):
        if AUTH_CHANNEL:
            ...
            try:
                ...
                await bot.send_message(
                    chat_id=cmd.from_user.id,
                    text="**താഴെ കാണുന്ന 🔸Join Channel🔹എന്നതിൽ Click ചെയ്ത് ചാനലിൽ ജോയിൻ ചെയ്യുക... ശേഷം വീണ്ടും ഇതിലേക്ക് വന്നിട്ട് 🔄 Try Again 🔄 എന്ന് Click ചെയ്യുക... എങ്കിൽ മാത്രമേ സിനിമ ലഭിക്കൂ ☺️!**",
